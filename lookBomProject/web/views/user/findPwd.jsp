...
<div align = "center">
	<h2>ID/PW 찾기</h2>
	<table>
	<input type = "button" value = "아이디" style = "border : 0px; color : black; background-color : gray; width : 150px; height : 50px;" onclick = "findId();">
	<input type = "button" value = "비밀번호"style = "border : 0px; color : white; background-color : black; width : 150px; height : 50px;">
	</table>
	<table>
	<br>
		<tr>
